...
class trx_utils_demo_data_importer {
	...
	function __construct() {
		...
		add_action('wp_ajax_nopriv_trx_utils_importer_start_import',	array($this, 'importer'));
		...
		add_action('wp_ajax_nopriv_trx_utils_importer_get_list_pages',	array($this, 'get_list_pages_callback'));
	...
	<li><?php echo wp_kses_data(__('<b>ALL EXISTING CONTENTS</b> of your website will be deleted and replaced with the new data!', 'trx_utils')); ?></li>
					...
					<p><b><?php esc_html_e('Select the elements to be imported:', 'trx_utils'); ?></b></p>
	...
	function importer() {
		...
		if ( !isset($_POST['importer_action']) || !wp_verify_nonce( trx_utils_get_value_gp('ajax_nonce'), 'ajax_nonce' ) )
			die();
