...
if (!function_exists('themerex_plugins_query_add_sort_order')) {
	function themerex_plugins_query_add_sort_order($args, $orderby='date', $order='desc') {
		$q = array();
		$q['order'] = $order;
		if ($orderby == 'comments') {
...
if (!function_exists('themerex_plugins_query_add_posts_and_cats')) {
	function themerex_plugins_query_add_posts_and_cats($args, $ids='', $post_type='', $cat='', $taxonomy='') {
		if (!empty($ids)) {
